...
//            return null;
//        }
//        HashMap<Integer, Integer> map = new HashMap<>();//中序遍历结果放在hashmap中
...
//     * @return
//     */
//    private static TreeNode construct(int[] pre, int ps, int pe, int[] in, int is, int ie, HashMap<Integer, Integer> map) {
//
//        if (ps>pe){
...
//        //递归：
//        //其实这里，i-is就是本次中序遍历中使用到的数组长度，与前序遍历结果相同
